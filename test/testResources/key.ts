...
const defaultMasterKey: D4LKeySym = {
    t: D4LKeyTypes.PASSWORD_KEY,
    v: 1,
    sym: 'By+2DGaiPLZ+ou4c+9qMoZW7h0ceEBetavR6+BtjoQk=',
};
const IV = new Uint8Array([0, 1, 2, 3, 4, 5, 6, 7, 0, 1, 2, 3, 4, 5, 6, 7]);
const masterKey: D4LKeySym = {
    t: D4LKeyTypes.PASSWORD_KEY,
    v: 1,
    sym: '4UTwQYSMuRewAREYU5DvE+MknqCLyXp+PWUMKPxm4h0=',
};

const symMainKey: D4LKeySym = {
    t: D4LKeyTypes.MAIN_KEY,
    v: 1,
...
const symCommonKey: D4LKeySym = {
    t: D4LKeyTypes.COMMON_KEY,
    v: 1,
...
const symTagKey: D4LKeySym = {
    t: D4LKeyTypes.TAG_ENCRYPTION_KEY,
    v: 1,
...
const asymUserPrivateKey: D4LKeyPrivate = {
    t: D4LKeyTypes.USER_PRIVATE_KEY,
    v: 1,
...
const asymUserPublicKey: D4LKeyPublic = {
    t: D4LKeyTypes.USER_PUBLIC_KEY,
    v: 1,
